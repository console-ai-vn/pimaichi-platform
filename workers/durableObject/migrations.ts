...
export const mailboxMigrations: Migration[] = [
	...
	},
	{
		...
		sql: `
            ...
            CREATE UNIQUE INDEX IF NOT EXISTS idx_conversation_participants_thread_contact ON conversation_participants(thread_id, contact_id);
        `,
	},
	{
		name: "10_add_conversation_state",
		sql: `
            ...
            CREATE INDEX IF NOT EXISTS idx_conversation_state_assignee ON conversation_state(assignee_email);
        `,
	},
	{
		name: "11_add_internal_notes_events",
		sql: `
            ...
            CREATE INDEX IF NOT EXISTS idx_internal_notes_thread ON internal_notes(thread_id, created_at);
            CREATE INDEX IF NOT EXISTS idx_conversation_events_thread ON conversation_events(thread_id, created_at);
        `,
	},
	{
		name: "12_add_contact_profile_fields",
		sql: `
            ALTER TABLE contacts ADD COLUMN bio TEXT;
            ALTER TABLE contacts ADD COLUMN contact_description TEXT;
	...
	{
		name: "13_add_contact_memory_fields",
		sql: `
            ALTER TABLE contacts ADD COLUMN relationship_stage TEXT;
            ALTER TABLE contacts ADD COLUMN tags TEXT;
            ALTER TABLE contacts ADD COLUMN memory TEXT;
        `,
	},
	{
		name: "14_add_audit_log",
		sql: `
	...
	{
		name: "15_add_mailbox_permissions",
		sql: `
