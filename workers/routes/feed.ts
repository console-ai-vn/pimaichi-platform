	...
	const items = [
		{
			...
			thumbnailUrl: "/api/v1/media/placeholder-1.jpg",
			imageId: null,
			title: "Buổi sáng mới 🌸",
		...
		},
		{
			...
			creatorName: "Pimaichi1003",
			creatorAvatarUrl: null,
			thumbnailUrl: "/api/v1/media/placeholder-2.jpg",
			imageId: null,
		...
		},
		{
			...
			creatorName: "Pimaichi1003",
			creatorAvatarUrl: null,
			thumbnailUrl: "/api/v1/media/placeholder-3.jpg",
			imageId: null,
		...
		},
		{
			...
			creatorName: "Pimaichi1003",
			creatorAvatarUrl: null,
			thumbnailUrl: "/api/v1/media/placeholder-4.jpg",
			imageId: null,
		...
		},
		{
			...
			creatorName: "Pimaichi1003",
			creatorAvatarUrl: null,
			thumbnailUrl: "/api/v1/media/placeholder-7.jpg",
			imageId: null,
	...
	const stories = [
		{
			...
			avatarUrl: null,
			imageId: null,
			imageUrl: "/api/v1/media/placeholder-1.jpg",
			tier: "public" as const,
			seen: false,
			live: true,
		},
		{
			...
			avatarUrl: null,
			imageId: null,
			imageUrl: "/api/v1/media/placeholder-2.jpg",
			tier: "subscribers" as const,
			seen: true,
			live: false,
		},
		{
			...
			avatarUrl: null,
			imageId: null,
			imageUrl: "/api/v1/media/placeholder-3.jpg",
			tier: "ppv" as const,
			seen: false,
			live: false,
		},
