...
export default function EmailPanel({ emailId }: { emailId: string }) {
	...
	const { closePanel, startCompose, openAgentPanel } = useUIStore();
	...
	if (!isDraftFolder) {
		return (
			<ChatConversationView
				...
				draftMessageIds={draftMessageIds}
				isSending={isSending}
	...
	return (
		<div className="relative flex h-full flex-col">
			<EmailPanelToolbar
				...
				onSendDraft={() => handleSendDraft()}
				onEditDraft={() => handleEditDraft()}
				onReply={() => startCompose({ mode: "reply", originalEmail: email })}
				onReplyAll={() => startCompose({ mode: "reply-all", originalEmail: email })}
